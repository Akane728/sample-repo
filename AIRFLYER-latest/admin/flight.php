  ...
  <div class="row">
    ...
    ?><!-- log on to codeastro.com for more projects -->
      ...
      <form method="POST" class=" text-center" 
        action="../includes/admin/lindsytry.inc.php">
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">RETURN</h5>
          </div>
          <div class="col">    <!-- log on to codeastro.com for more projects -->       
        ...
        <div class="col-md-3 ">
          ...
          <div class="col">
            <input type="date" name = "return_arr_date" class="form-control"
             >
          </div>
          <div class="col">
            <input type="time" name = "return_arr_time" class="form-control"
            >
          </div>
        </div>
        ...
        <div class="form-row mb-4">
          ...
          <div class="col">
            ...
            // mysqli_stmt_execute($stmt);          
            // $result = mysqli_stmt_get_result($stmt);    
            // echo '<select class="mt-4" name="source_city" style="border: 0px; border-bottom: 
            //   2px solid #5c5c5c; background-color: whitesmoke !important;
            //   font-weight: bold !important;
            //   width:80%">
            //   <option selected>To</option>';
          ...
          <div class="col"> -->
              ...
              // mysqli_stmt_execute($stmt);          
              // $result = mysqli_stmt_get_result($stmt);    
              // echo '<select class="mt-4" name="return_city" style="border: 0px; border-bottom: 
              //   2px solid #5c5c5c; background-color: whitesmoke !important;
              //   font-weight: bold !important;
              //   width:80%">
              //   <option selected>From</option>';
