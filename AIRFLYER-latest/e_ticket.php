                  ...
                  if(!mysqli_stmt_prepare($stmt_f,$sql_f)) {
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                        ...
                        <div class="col-3 bord pl-0" style="background-color:#376b8d;
                            ...
                            <div class="row justify-conStent-center">
                                <div class="col-12">                                    
                            ...
                            echo '
                                ...
                                <div class="col-9 out">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <p class="head">departure</p>
                                            <p class="txt mb-1">'.$return_date_dep.'</p>
                                            <p class="h1 font-weight-bold mb-3">'.$return_time_dep.'</p>  
                                        </div>            
                                        <div class="col-3">
                                            <p class="head">arrival</p>
                                            <p class="txt mb-1">'.$return_date_arr.'</p>
                                            <p class="h1 font-weight-bold mb-3">'.$return_time_arr.'</p>  
                                        </div>
                                        <div class="col-3">
                                            <p class="head">gate</p>
                                            <p class="txt">A22</p>
